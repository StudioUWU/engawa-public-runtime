...
set(_er_psl_generator "${SOURCE_PATH}/src/psl-make-dafsa")
file(READ "${_er_psl_generator}" _er_psl_generator_text)
set(_er_psl_original
    "bytes(psl_input_file, **codecs)")
string(REGEX MATCHALL "bytes\\(psl_input_file, \\*\\*codecs\\)"
    _er_psl_matches
    "${_er_psl_generator_text}")
list(LENGTH _er_psl_matches _er_psl_match_count)
if (NOT _er_psl_match_count EQUAL 1)
    message(FATAL_ERROR
        "The production libpsl filename scrub expected one generator expression, "
        "found ${_er_psl_match_count}.")
endif ()
vcpkg_replace_string(
    "${_er_psl_generator}"
    "${_er_psl_original}"
    "bytes('engawaruntime-production/public_suffix_list.dat', **codecs)")
...
if (VCPKG_LIBRARY_LINKAGE STREQUAL "static")
    vcpkg_replace_string(
        "${CURRENT_PACKAGES_DIR}/include/libpsl.h" "defined PSL_STATIC" "1")
endif ()

file(MAKE_DIRECTORY "${CURRENT_PACKAGES_DIR}/tools/${PORT}")
file(RENAME "${CURRENT_PACKAGES_DIR}/bin/psl-make-dafsa"
    "${CURRENT_PACKAGES_DIR}/tools/${PORT}/psl-make-dafsa")
